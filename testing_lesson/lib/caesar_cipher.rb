...
class Cipher
  def self.caesar_cipher(string, key = 0)
...
#test = Cipher.new
Cipher.caesar_cipher("Zoo and", 5)
Cipher.decrypt("ett fsi", 5)
Cipher.caesar_cipher("a")
test = Cipher.caesar_cipher(" ")
puts test.each_byte
