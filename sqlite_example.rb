...
$db.results_as_hash = true #forces results to be displayed as hash
...
#creates a table for an example 'people' table
def create_table
  puts "Creating table"
  $db.execute %q{
    CREATE TABLE people (
...
#searches for an existing record by name or id
def find_person
